...
import PatientDashboardService from '../service/PatientDashboard-service';
...
export default class HealthIndicators extends LitElement {
  ...
  constructor() {
    super();
    this.patientDashboardService.getWeight().then((data) => {
      this.patientDashboardWeight = data;
    }, err => console.log(err));
    this.patientDashboardService.getHeartRate().then((data) => {
      this.patientDashboardHeartRate = data;
    }, err => console.log(err));
    this.patientDashboardService.getBPSystolicDiastolic().then((data) => {
      this.patientDashboardBPSystolicDiastolic = data;
    }, err => console.log(err));
    this.patientDashboardService.getGlucose().then((data) => {
      this.patientDashboardGlucose = data;
    }, err => console.log(err));
    this.patientDashboardService.getTotalCholesterol().then((data) => {
      this.patientDashboardTotalCholesterol = data;
    }, err => console.log(err));
    this.patientDashboardService.getCholesterolHDLLDL().then((data) => {
      this.patientDashboardCholesterolHDLLDL = data;
    }, err => console.log(err));
  }

  private patientDashboardService: PatientDashboardService = new PatientDashboardService();

  @property()
  private patientDashboardWeight?: any[];

  @property()
  private patientDashboardHeartRate?: any[];

  @property()
  private patientDashboardBPSystolicDiastolic?: any[];

  @property()
  private patientDashboardGlucose?: any[];

  @property()
  private patientDashboardTotalCholesterol?: any[];

  @property()
  private patientDashboardCholesterolHDLLDL?: any[];
