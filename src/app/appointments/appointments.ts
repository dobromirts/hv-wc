...
export default class Appointments extends LitElement {
  ...
  public cancelApptDialog?: IgcDialogComponent;
  ...
  render() {
    return html`
        ...
        <div class="column-layout group_1">
          ...
          <div class="column-layout group_9">
            <div class="row-layout group_10">
              <igc-avatar src="/src/assets/Avatar4.png" shape="circle" class="avatar avatar_1"></igc-avatar>
            ...
            <igc-list class="list">
              ...
              <igc-list-item>
                <div slot="start">
                  <igc-avatar shape="circle" class="avatar avatar_4">
          ...
          <div class="row-layout group_13">
            <igc-button variant="flat" @click=${() => this.cancelApptDialog?.toggle()} class="button">
              <span class="material-icons">
                close
              </span>
              <span>CANCEL</span>
            ...
            <igc-button class="button button_2">
              <span class="material-icons">
                calendar_today
              </span>
      ...
      <igc-dialog ?close-on-outside-click="${true}" ?close-on-escape="${true}" id="cancel-appt-dialog">
        <h5 slot="title">
        ...
        <div slot="footer">
          <igc-button variant="flat" @click=${() => this.cancelApptDialog?.toggle()} class="button_1">
            No, go back
            <igc-ripple></igc-ripple>
          </igc-button>
          <igc-button variant="flat" @click=${() => this.cancelApptDialog?.toggle()} class="button_1 button_1_1">
            Yes, cancel
            <igc-ripple></igc-ripple>
          </igc-button>
        </div>
